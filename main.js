...
var barWidth, chart, chartInset, degToRad, repaintGauge,
  ...
  // Create SVG element
  svg = el.append('svg').attr('width', width + margin.left + margin.right).attr('height', (height + margin.top + margin.bottom) / 1.8 - 100 ).style("display","block").style("margin","auto").style("margin-top","-35%");
